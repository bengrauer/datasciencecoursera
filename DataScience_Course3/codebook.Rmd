...
This code book was designed to explain the code, transformations steps, and variables associated with the data cleanup. 
...
This code area the data set to pivot the data for easier grouping.  The temporary csv file was used to verify the counts/checks of the data in Excel.  
